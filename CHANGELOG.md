...
- Added support for native Nova Repeatable fields (thanks to [@jan-tricks](https://github.com/jan-tricks))
- Package updates, Node 24 support (thanks to [@jan-tricks](https://github.com/jan-tricks))
